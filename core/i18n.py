...
# v0.0.1 agent-workflow interface.  Keeping the additions together makes it
# straightforward to audit English/Arabic parity during the redesign.
_REVAMP_TRANSLATIONS = {
    "en": {
        ...
        "xlsx_only_hint": "Excel .xlsx workbooks only. Your BOQ rows are never displayed in Tawreed.",
        ...
        "about_privacy_text": "BOQ rows stay out of the interface. Credentials use the operating-system keyring, and Codex sign-in tokens are never copied or stored by Tawreed.",
    },
    "ar": {
        ...
        "xlsx_only_hint": "ملفات Excel بصيغة .xlsx فقط. لا يعرض توريد صفوف جدول الكميات.",
        ...
        "about_privacy_text": "لا تظهر صفوف جدول الكميات في الواجهة. تُحفظ بيانات الاعتماد في مخزن النظام، ولا ينسخ توريد رموز تسجيل دخول Codex أو يخزنها.",
    },
}
for _language, _strings in _REVAMP_TRANSLATIONS.items():
    TRANSLATIONS[_language].update(_strings)
