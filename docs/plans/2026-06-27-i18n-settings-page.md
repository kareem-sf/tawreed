# Plan: Route Hard-Coded Settings Page Strings Through i18n

## Problem
The settings page contains several hard-coded English strings that should be routed through the i18n system for proper Arabic/English bilingual support.

## User Impact
- Arabic-speaking users see English strings in the settings page
- Inconsistent i18n coverage across the application
- Missed opportunity for full bilingual support

## Target Behavior
All visible UI strings in the settings page should use the i18n system:
...
- `gui/pages/settings_page.py` - Route strings through i18n
...
## Acceptance Criteria
- All hard-coded English strings in settings page use i18n
...
- Manual verification: Launch app, switch between English/Arabic, verify all settings strings translate
...
2. Update `gui/pages/settings_page.py` to use `i18n.tr()` for all user-facing strings
3. Run tests
